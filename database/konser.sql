...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2024 at 04:14 PM
...
(2, 'Suara Manahan', 'Jawa Tengah', '2024-06-19', 'Guyon Waton', 'Guyon Waton merupakan grup musik dangdut dan Pop Jawa Indonesia yang berasal dari Kabupaten Kulon Progo, Daerah Istimewa Yogyakarta. Guyon Waton terbentuk pada tahun 2015. Nama Guyon Waton berasal dari kata \"Guyon\" yang artinya bercanda dan \"Waton\" artinya asal, sehingga Guyon Waton artinya bercanda asal.', 'Stadion Manahan, Surakarta, Jawa Tengah', 'guyonwaton.png', 'guyonwaton.php', 1),
(3, 'We The Fest', 'Jakarta Utara', '2024-06-12', 'Tulus', 'Muhammad Tulus, S.Ars adalah penyanyi-penulis lagu berkebangsaan Indonesia. Tulus memulai karier profesionalnya sejak tahun 2011 melalui label rekaman independen TulusCompany yang didirikannya. Hampir semua karya musik yang dirilisnya adalah hasil karya ciptanya sendiri.', 'Jakarta International Expo, Jakarta Utara', 'tulus.png', 'tulus.php', 1);
...
(1, 'VIP', 150000, 4, 96),
(2, 'Gold', 100000, 0, 300),
(3, 'Silver', 75000, 0, 400),
(4, 'Bronze', 50000, 0, 500);
...
INSERT INTO `transactions` (`idTransaction`, `nameTransaction`, `telpTransaction`, `mailTransaction`, `idConcert`, `idAccount`, `idTicket`, `qtyTransaction`, `statusTicket`, `transactionDate`) VALUES
(15, 'Gusti Padaka', 827348373, 'gutsi222@gmail.co', 3, 1, 1, 3, 'Available', '2024-06-09'),
(16, 'Atong Geong', 81954453, 'atongkowww@hago.com', 2, 1, 1, 1, 'Available', '2024-06-09');
